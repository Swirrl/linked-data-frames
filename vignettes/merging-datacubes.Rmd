...
```{r}
# example of linear model + scatter plot from row-bound joined cube

# X vs population for something
# demonstrate that X is bigger if there are more people :D
# calculate population-rate of X
```

```{r}
# example of tidy::spread() on above to calculate ratio
```
